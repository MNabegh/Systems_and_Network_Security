...
class DES():
    ...
    def __init__(self,key): #input data64bits,key64bits
        self.keys = []
        self.result=[]
        ...
        string = file.read()
        file.close()
        inputData = textToBinVector(string)
...
keyInHex = keyFromHexToBinVector("319df2f409baee3c",64)
keyInText = textToBinVector("secret_k")
new = DES(keyInText)
